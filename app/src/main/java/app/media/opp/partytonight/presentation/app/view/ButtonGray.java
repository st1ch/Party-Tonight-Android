...
public class ButtonGray extends Button {
    private static final int RID_BACKGROUND_DRAWABLE = R.drawable.button_gray;
    ...
    public ButtonGray(Context context) {
        super(context);

        configureView(context);
    }

    public ButtonGray(Context context, AttributeSet attrs) {
        super(context, attrs);

        configureView(context);
    }

    public ButtonGray(Context context, AttributeSet attrs, int defStyleAttr) {
