...
public class ButtonCurvedBottomLeft extends Button {

    private static final int RID_BACKGROUND_DRAWABLE = R.drawable.bg_dialog_left_button;
    ...
    public ButtonCurvedBottomLeft(Context context) {
        super(context);

        configureView(context);
    }

    public ButtonCurvedBottomLeft(Context context, AttributeSet attrs) {
        super(context, attrs);

        configureView(context);
    }

    public ButtonCurvedBottomLeft(Context context, AttributeSet attrs, int defStyleAttr) {
