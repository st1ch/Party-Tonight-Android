...
public class ButtonCurvedBottomRight extends Button {

    private static final int RID_BACKGROUND_DRAWABLE = R.drawable.bg_dialog_right_button;
    ...
    public ButtonCurvedBottomRight(Context context) {
        super(context);

        configureView(context);
    }

    public ButtonCurvedBottomRight(Context context, AttributeSet attrs) {
        super(context, attrs);

        configureView(context);
    }

    public ButtonCurvedBottomRight(Context context, AttributeSet attrs, int defStyleAttr) {
