...
import app.media.opp.partytonight.domain.usecase.GoerSignInUseCase;
...
@UserScope
public class GoerSignInPresenter extends ProgressPresenter<ICredentialView> implements ISignInPresenter {
    private GoerSignInUseCase useCase;

    @Inject
    public GoerSignInPresenter(Messages messages, GoerSignInUseCase useCase) {
        super(messages);
