...
public class EditTextAgudaMultiline extends EditText {
    ...
    public EditTextAgudaMultiline(Context context) {
        super(context);

        configureView(context);
    }

    public EditTextAgudaMultiline(Context context, AttributeSet attrs) {
        super(context, attrs);

        configureView(context);
    }

    public EditTextAgudaMultiline(Context context, AttributeSet attrs, int defStyleAttr) {
